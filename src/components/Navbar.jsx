  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-14 bg-white border-b border-gray-200 flex items-center px-8 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        <span className="text-xs text-gray-400 px-3 py-1.5 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50">마이페이지</span>
        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-700 to-green-400 text-white text-sm font-bold flex items-center justify-center cursor-pointer">전</div>
      </div>
    </nav>
  )
}
